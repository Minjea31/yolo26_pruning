...
- `asset/C2PSA.jpeg`: 직접 작성한 pruning용 architecture/channel 정의 이미지

## Architecture 이미지

`asset/C2PSA.jpeg`는 YOLO26 pruning 과정에서 C2PSA 블록의 architecture를 직접 그리고, channel pruning에 필요한 channel 변수를 정의해 둔 이미지입니다.
