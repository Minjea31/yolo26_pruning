...
class PruneHandler():
    ...
    def reconstruct(self):
        ...
        for name, module in self.model.model.model.named_modules():
            if isinstance(module, Conv):
                ...
                if name == '12':
                    concat['6'][0] = [x + concat['11'][1] for x in concat['6'][0]]
                    remain_out_channels = concat['11'][0] + concat['6'][0]
                elif name == '15':
                    concat['4'][0] = [x + concat['14'][1] for x in concat['4'][0]]
                    remain_out_channels = concat['14'][0] + concat['4'][0]
                elif name == '18':
    ...
    def model_to_yaml(self):
        ...
        with open(f'/home/a/yolo26_pruning/{self.cfg_output_path}/c_bestmodel.yaml', "w") as file:
            file.write(yaml_str)
