...
if not args.resume_path:
    ...
    cmodel.train(data="/home/a/yolo26_pruning/dataset.yaml", epochs=args.epoch, imgsz=640, resume=False,
                 device=args.device, name=args.name, batch=args.bs, workers=8,
                 project='checkpoints')
else:
    cmodel = YOLO(args.resume_path)
    cmodel.train(data="/home/a/yolo26_pruning/dataset.yaml", epochs=50, imgsz=640, device=args.device, name=args.name, batch=args.bs, workers=8, resume=True, project='checkoints')
